...
local CiderRunMode = {};CiderRunMode.runmode = 'DEBUG';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/viraj/Library/Application Support/luaglider2/dev";local SOCKET_PORT=54304;local GLIDER_MAIN_FOLDER= "/Users/viraj/Documents/Projects/Corona/Normal/ASAP-Ferg-Game-master/src";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
