...
orders[#orders+1] = { customer=01, order={ {'B','S5'},{'B','P1','C'}}}
orders[#orders+1] = { customer=01, order={ {'S1','H4','G'}}}
orders[#orders+1] = { customer=01, order={ {'S2','C','G'}}}
orders[#orders+1] = { customer=01, order={ {'C','S1'},{'H3','G','A'}}}
...
orders[#orders+1] = { customer=01, order={ {'W2','H4'},{'S4',"W1",'A'}}}
orders[#orders+1] = { customer=01, order={ {'S2','P5','W2'}}}
orders[#orders+1] = { customer=01, order={ {'H2','P4','G'}}}
orders[#orders+1] = { customer=01, order={ {'P6','S6'},{'T','C','C'}}}
